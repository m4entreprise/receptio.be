...
class AgentSettingsController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'conversation_enabled' => ['sometimes', 'boolean'],
            'conversation_prompt' => ['nullable', 'string', 'max:5000'],
            'max_clarification_turns' => ['required', 'integer', 'min:1', 'max:5'],
        ...
        AgentConfig::updateOrCreate(
            ...
            [
                ...
                'conversation_enabled' => (bool) ($validated['conversation_enabled'] ?? false),
                'conversation_prompt' => $validated['conversation_prompt'] ?? null,
                'max_clarification_turns' => $validated['max_clarification_turns'],
