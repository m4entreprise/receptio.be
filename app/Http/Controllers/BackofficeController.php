...
class BackofficeController extends Controller
{
    ...
    private function buildContext(Request $request): array
    {
        ...
        $settings = [
            ...
            'conversation_enabled' => (bool) ($agentConfig?->conversation_enabled ?? false),
    ...
    private function mapCall(Call $call): array
    {
        ...
        return [
            ...
            'message' => $call->message ? [
                ...
                'recording_playback_url' => $call->message->recording_url ? route('dashboard.messages.recording', $call->message->id) : null,
    ...
    private function mapMessage(CallMessage $message): array
    {
        ...
        return [
            ...
            'recording_playback_url' => $message->recording_url ? route('dashboard.messages.recording', $message->id) : null,
